    ...
    return Container(
      ...
      child: Column(children: [
            ...
            Expanded(child: GestureDetector(
              ...
              child: Container(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text(lang.s('Manual Entry', 'በእጅ ያስገቡ'),
                      style: TextStyle(
        ...
        Expanded(child: _useQr ? _QrPlaceholder() : SingleChildScrollView(
          ...
          child: Column(children: [
            _LF(_hb,    lang.s('Hemoglobin (Hb)',   'ሄሞግሎቢን (Hb)'),   'e.g. 12.5', Icons.bloodtype_rounded,        TColors.red400),
            _LF(_sys,   lang.s('Systolic BP',        'ሲስቶሊክ ደም ግፊት'), 'e.g. 118',  Icons.monitor_heart_rounded,    TColors.blue500),
            _LF(_dia,   lang.s('Diastolic BP',       'ዳያስቶሊክ'),        'e.g. 76',   Icons.monitor_heart_outlined,   TColors.blue300),
            _LF(_sugar, lang.s('Blood Sugar',        'የደም ስኳር'),       'e.g. 95',   Icons.water_drop_rounded,       TColors.statusYellow),
            _LF(_weight,lang.s('Weight (kg)',        'ክብደት (ኪ.ግ.)'),   'e.g. 62',   Icons.monitor_weight_rounded,   TColors.teal500),
...
class _LF extends StatelessWidget {
  ...
  const _LF(this.ctrl, this.label, this.hint, this.icon, this.iconColor);
  ...
  Widget build(BuildContext context) {
    ...
    return Center(child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 20),
        Text(lang.s('Point camera at the clinic QR code',
